...
- (void)appDidBecomeActive:(NSNotification * _Nonnull)notification;
...
SWIFT_CLASS("_TtC8Mixpanel36MixpanelNotificationServiceExtension") SWIFT_AVAILABILITY(ios,introduced=11.0)
@interface MixpanelNotificationServiceExtension : UNNotificationServiceExtension
...
- (void)mp_userNotificationCenter:(UNUserNotificationCenter * _Nonnull)center newDidReceive:(UNNotificationResponse * _Nonnull)response withCompletionHandler:(void (^ _Nonnull)(void))completionHandler;
@end
...
- (void)mp_application:(UIApplication * _Nonnull)application newDidReceiveRemoteNotification:(NSDictionary * _Nonnull)userInfo fetchCompletionHandler:(void (^ _Nonnull)(UIBackgroundFetchResult))completionHandler;
- (void)mp_application:(UIApplication * _Nonnull)application newDidReceiveRemoteNotification:(NSDictionary * _Nonnull)userInfo;
@end
