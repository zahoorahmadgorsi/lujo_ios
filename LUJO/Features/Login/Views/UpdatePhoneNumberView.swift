...
class UpdatePhoneNumberView: UIViewController, LoginViewProtocol, CountrySelectionDelegate {
    ...
    @IBOutlet weak var btnAlreadyHaveTheCode: UIButton!
    ...
    fileprivate func updateUI() {
        ...
        //hide already have the code option if user is coming to edit his phone number
        btnAlreadyHaveTheCode.isHidden = isChanging
