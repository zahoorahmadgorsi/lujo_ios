...
extension LoginError: LocalizedError {
    public var errorDescription: String? {
        ...
        case .missingData:
            return NSLocalizedString("Please provide all required data.", comment: "")
        case .passwordMistmatch:
...
//    }
    ...
    func createAccount(title: UserTitle,
        ...
        presenterInteractor.createAccount(currentUser!, captchaToken: captchaToken) { [weak self] _, error in
            self?.view.hideNetworkActivity()
