...
class PaymentAPIManagerNEW {
    ...
    func validateReferralCode(_ token: String,_ code: String,_ membershipPlanId: Int, completion: @escaping (ReferralValidation?, Error?) -> Void) {
        
        Alamofire.request(PaymentRouter.validateReferralCode(token, code, membershipPlanId))
    ...
    func confirmMembershipPayment(_ membershipId: Int,_ transactionId: String?,_ amount: Double?,_ code: String?,_ token: String, completion: @escaping (Membership?, Error?) -> Void) {
