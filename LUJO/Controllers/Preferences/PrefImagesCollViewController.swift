...
//        self.contentView.addViewBorder( borderColor: UIColor.white.cgColor, borderWith: 1.0,borderCornerRadius: 12.0)
    ...
    func getPrefMasterData() {
        ...
        case .travel:
            switch prefInformationType {
            case .travelDestinationType:
                let taxonomyObj1 = Taxonomy(termId:"asdf1234qwer" , name: "Adventure")
                let taxonomyObj2 = Taxonomy(termId:"asdf1234qwer" , name: "Ski")
                let taxonomyObj3 = Taxonomy(termId:"asdf1234qwer" , name: "Beach")
                let taxonomyObj4 = Taxonomy(termId:"asdf1234qwer" , name: "Nature")
                let taxonomyObj5 = Taxonomy(termId:"asdf1234qwer" , name: "Urban")
                let taxonomyObj6 = Taxonomy(termId:"asdf1234qwer" , name: "Wellness")
            ...
            case .travelAirlines:
                let taxonomyObj1 = Taxonomy(termId:"asdf1234qwer" , name: "American")
                let taxonomyObj2 = Taxonomy(termId:"asdf1234qwer" , name: "British")
                let taxonomyObj3 = Taxonomy(termId:"asdf1234qwer" , name: "Delta")
                let taxonomyObj4 = Taxonomy(termId:"asdf1234qwer" , name: "Emirates")
                let taxonomyObj5 = Taxonomy(termId:"asdf1234qwer" , name: "KLM")
                let taxonomyObj6 = Taxonomy(termId:"asdf1234qwer" , name: "Lufthansa")
                let taxonomyObj7 = Taxonomy(termId:"asdf1234qwer" , name: "Qantas")
                let taxonomyObj8 = Taxonomy(termId:"asdf1234qwer" , name: "Air France")
                let taxonomyObj9 = Taxonomy(termId:"asdf1234qwer" , name: "United")
                let taxonomyObj10 = Taxonomy(termId:"asdf1234qwer" , name: "Japan Airlines")
                let taxonomyObj11 = Taxonomy(termId:"asdf1234qwer" , name: "South African")
                let taxonomyObj12 = Taxonomy(termId:"asdf1234qwer" , name: "Singapore Airlines")
                let taxonomyObj13 = Taxonomy(termId:"asdf1234qwer" , name: "Air India")
                let taxonomyObj14 = Taxonomy(termId:"asdf1234qwer" , name: "Saudia")
                let taxonomyObj15 = Taxonomy(termId:"asdf1234qwer" , name: "Qatar")
                var taxonomies = [Taxonomy]()
                taxonomies.append(taxonomyObj1)
                taxonomies.append(taxonomyObj2)
                taxonomies.append(taxonomyObj3)
                ...
                self.itemsList = taxonomies
            case .travelHotelStyles:
                let taxonomyObj1 = Taxonomy(termId:"asdf1234qwer" , name: "Chain(Brand)")
                let taxonomyObj2 = Taxonomy(termId:"asdf1234qwer" , name: "Modern")
                let taxonomyObj3 = Taxonomy(termId:"asdf1234qwer" , name: "Boutique")
                let taxonomyObj4 = Taxonomy(termId:"asdf1234qwer" , name: "Traditional")
                var taxonomies = [Taxonomy]()
                taxonomies.append(taxonomyObj1)
                taxonomies.append(taxonomyObj2)
                taxonomies.append(taxonomyObj3)
        ...
        case .profile:
            let taxonomyObj1 = Taxonomy(termId:"asdf1234qwer" , name: "aviation")
            let taxonomyObj2 = Taxonomy(termId:"asdf1234qwer" , name: "dining")
            let taxonomyObj3 = Taxonomy(termId:"asdf1234qwer" , name: "events")
            let taxonomyObj4 = Taxonomy(termId:"asdf1234qwer" , name: "experience")
            let taxonomyObj5 = Taxonomy(termId:"asdf1234qwer" , name: "gifts")
            let taxonomyObj6 = Taxonomy(termId:"asdf1234qwer" , name: "travel")
            let taxonomyObj7 = Taxonomy(termId:"asdf1234qwer" , name: "properties")
            let taxonomyObj8 = Taxonomy(termId:"asdf1234qwer" , name: "yachting")
